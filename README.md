...
> **Importing the Binary:** Regardless of the long, system-specific binary filename generated by your compiler, Python treats the file simply by its base module name. You can import it directly from your binary directory as from bin.f1sim import LangevinGillespie
